...
* 
*/
class T_tabel9e extends CI_Controller
{
	...
	public function index(){
        ...
        $this->load->view('templates_tabel_view/tabel9e');					//$this->load->view('templates_admin/dashboard', $data);
    ...
    public function tambahtabel(){
        ...
        $this->load->view('templates_tabel/tambah_tabel9e');					//$this->load->view('templates_admin/dashboard', $data);
    ...
    public function edittabel(){
        ...
        $this->load->view('templates_pic/header');
        $this->load->view('templates_pic/sidebar');
        $this->load->view('templates_tabel_edit/tambah_tabel9e');					//$this->load->view('templates_admin/dashboard', $data);
        $this->load->view('templates_pic/footer');
	}
