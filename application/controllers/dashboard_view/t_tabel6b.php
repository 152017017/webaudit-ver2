...
class T_tabel6b extends CI_Controller
{
	...
	public function index(){
        ...
        $this->load->view('templates_tabel_view/tabel6b');					//$this->load->view('templates_admin/dashboard', $data);
    ...
    public function edittabel(){
        ...
        $this->load->view('templates_pic/header');
        $this->load->view('templates_pic/sidebar');
        $this->load->view('templates_tabel_edit/tambah_tabel6b');					//$this->load->view('templates_admin/dashboard', $data);
        $this->load->view('templates_pic/footer');
	}
}
