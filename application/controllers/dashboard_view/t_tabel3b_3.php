...
* 
*/
class T_tabel3b_3 extends CI_Controller
{
	...
	public function index(){
        ...
        $this->load->view('templates_tabel_view/tabel3b_3');					//$this->load->view('templates_admin/dashboard', $data);
    ...
    public function tambahtabel(){
        ...
        $this->load->view('templates_tabel/tambah_tabel3b_3');					//$this->load->view('templates_admin/dashboard', $data);
    ...
    public function edittabel(){
        ...
        $this->load->view('templates_pic/header');
        $this->load->view('templates_pic/sidebar');
        $this->load->view('templates_tabel_edit/tambah_tabel3b_3');					//$this->load->view('templates_admin/dashboard', $data);
        $this->load->view('templates_pic/footer');
	}
