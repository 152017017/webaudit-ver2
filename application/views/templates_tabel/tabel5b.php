...
<!-----------------------------	------------------------------------------------------------------------------------>
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Tabel 5.b Integrasi Kegiatan Penelitan/PkM dalam Pembelajaran</h6>
                        </div>
                        <p> <a onClick='top.location="<?php echo base_url('index.php/dashboard/t_tabel5b/tambahtabel')?>"' class="btn btn-success" data-target="#ModalAdd" data-toggle="modal">Tambah Data</a>
                        <div class="card-body">
                            <div class="table-responsive">
                            <?php
                            $no = 1;
                            ?>
                            <table class="table table-bordered" id="tabel5b" width="100%" cellspacing="0">
                            <caption>Tabel 5.b Integrasi Kegiatan Penelitan/PkM dalam Pembelajaran</caption>
                                <thead>
                                    <tr rowspan="2">
