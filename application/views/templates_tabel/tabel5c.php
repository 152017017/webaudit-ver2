...
<!-----------------------------	------------------------------------------------------------------------------------>
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Tabel 5.c Kepuasan Mahasiswa</h6>
                        </div>
                        <p> <a onClick='top.location="<?php echo base_url('index.php/dashboard/t_tabel5c/tambahtabel')?>"' class="btn btn-success" data-target="#ModalAdd" data-toggle="modal">Tambah Data</a>
                        <div class="card-body">
                            <div class="table-responsive">

                            <table class="table table-bordered" id="tabel5c" width="100%" cellspacing="0">
                            <caption>Tabel 5.c Kepuasan Mahasiswa</caption>
                                <thead>
                                    <tr rowspan="2">
