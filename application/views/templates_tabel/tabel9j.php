...
<!-----------------------------	------------------------------------------------------------------------------------>
					<!-- TABEL 9j: PERSENTASE KESESUAIAN RPS DALAM BAP, PENGEMBALIAN TUGAS, SOLUSI UTS DAN UAS, PENGEMBALIAN BERKAS  UJIAN, PROSES PENILAIAN, DAN PEMASUKAN NILAI UJIAN -->
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">TABEL 9j: PERSENTASE KESESUAIAN RPS DALAM BAP, PENGEMBALIAN TUGAS, SOLUSI UTS DAN UAS, PENGEMBALIAN BERKAS  UJIAN, PROSES PENILAIAN, DAN PEMASUKAN NILAI UJIAN</h6>
                        </div>
                        <p> <a onClick='top.location="<?php echo base_url('index.php/dashboard/t_tabel9j/tambahtabel')?>"' class="btn btn-success" data-target="#ModalAdd" data-toggle="modal">Tambah Data</a>                        
                        <div class="card-body">
                            <div class="table-responsive">
                            <table class="table table-bordered" id="tabel9j" width="100%" cellspacing="0">                            
                                <thead>
                                    <tr rowspan="2">
