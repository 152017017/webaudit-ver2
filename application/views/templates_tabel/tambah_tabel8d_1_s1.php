    ...
    <h3 class="h3 mb-0 text-gray-800">Masukkan Data Tabel 8d1 - S1</h3>                        
          <form action="aksi_tambah_audit_auditor.php" name="modal_popup" enctype="multipart/form-data" method="POST">                                     
            <!--- aks9_tambah_audit_auditor.php buat masukin data ke database -->
                ...
                <div class="form-group" style="padding-bottom: 10px;">
                    <label for="Modal Name">Jumlah Lulusan Terlacak dengan Waktu Tunggu < 6 Bulan</label>
                    <input type="number" name="<6bulan"  class="form-control"/>
                </div>  

                <div class="form-group" style="padding-bottom: 10px;">
                    <label for="Modal Name">Jumlah Lulusan Terlacak dengan Waktu Tunggu 6 ≤ WT ≤ 18 bulan</label>
                    <input type="number" name="6-18bulan"  class="form-control"/>
                </div>  

                <div class="form-group" style="padding-bottom: 10px;">
                    <label for="Modal Name">Waktu Tunggu > 18 bulan</label>
                    <input type="number" name=">18bulan"  class="form-control"/>
                </div>  
