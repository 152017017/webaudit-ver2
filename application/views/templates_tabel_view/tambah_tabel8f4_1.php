    ...
    <h3 class="h3 mb-0 text-gray-800">Masukkan Data Tabel 8f4 - 1</h3>                        
          <form action="aksi_tambah_audit_auditor.php" name="modal_popup" enctype="multipart/form-data" method="POST">                                     
            <!--- aks9_tambah_audit_auditor.php buat masukin data ke database -->
                ...
                <div class="form-group" style="padding-bottom: 10px;">
                    <label for="Modal Name">Luaran Penelitian dan PKM</label>
                    <input type="text" name="luaran"  class="form-control"/>
                </div>  

                <div class="form-group" style="padding-bottom: 10px;">
                    <label for="Modal Name">Tahun</label>
                    <input type="date" name="namaProduk"  class="form-control"/>
                </div> 
