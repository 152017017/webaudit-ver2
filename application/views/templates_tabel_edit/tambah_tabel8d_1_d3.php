    ...
    <h3 class="h3 mb-0 text-gray-800">Masukkan Data Tabel 8d1 - D3</h3>                        
          <form action="aksi_tambah_audit_auditor.php" name="modal_popup" enctype="multipart/form-data" method="POST">                                     
            <!--- aks9_tambah_audit_auditor.php buat masukin data ke database -->
                ...
                <div class="form-group" style="padding-bottom: 10px;">
                    <label for="Modal Name">Jumlah Mahasiswa Lulusan yang Dipesan Sebelum Lulus</label>
                    <input type="number" name="JumlahLulusDipesan"  class="form-control"/>
                </div>  

                <div class="form-group" style="padding-bottom: 10px;">
                    <label for="Modal Name">Waktu Tunggu < 3 Bulan</label>
                    <input type="number" name="<3bulan"  class="form-control"/>
                </div>  

                <div class="form-group" style="padding-bottom: 10px;">
                    <label for="Modal Name">Waktu Tunggu 3 ≤ WT ≤ 6 bulan</label>
