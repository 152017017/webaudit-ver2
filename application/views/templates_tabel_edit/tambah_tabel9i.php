    ...
    <h3 class="h3 mb-0 text-gray-800">Masukkan Data Tabel 9i</h3>                        
          <form action="aksi_tambah_audit_auditor.php" name="modal_popup" enctype="multipart/form-data" method="POST">                                     
            <!--- aks9_tambah_audit_auditor.php buat masukin data ke database -->
                ...
                <div class="form-group" style="padding-bottom: 20px;">
                  <label for="Modal Name">Ketersediaan Dokumen RPS, pilih Y apabila terdapat data RPS</label>
                  <select type="text" name="ketersediaan"  class="form-control">
                  <option value="">--Pilih Nilai Ketersediaan--</option>
