            ...
            <div id="content">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small">Kaprodi</span>
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Form Audit Kaprodi</h1>                       
                    </div>
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h9 class="m-0 font-weight-bold text-primary">Form Audit Kaprodi</h9>
                        </div>                                                        
                        ...
                        <div class="form-group" style="padding-bottom: 10px;">
                            ...
                            <input type="text" name="tglVisitasi" value="isinya butir yang dipilih" class="form-control"/>
                        </div>
                        ...
                        <div class="form-group" style="padding-bottom: 10px;">
                            ...
                            <input type="text" name="noIndikaotr" value="Sisanya otomatis nampil berdasarkan butir yang dipilih" class="form-control"/>
                        </div>
                        ...
                        <div class="form-group" style="padding-bottom: 10px;">
                            <label for="Modal Name">Tabel</label>
                            <input type="text" name="noIndikaotr" value="Sisanya otomatis nampil berdasarkan butir yang dipilih, dan bisa link ke tabel " class="form-control"/>
                        </div>
